        ...
        <header className="h-20 px-4 md:px-10 flex items-center justify-between border-b md:border-none border-gray-100 bg-white md:bg-transparent">
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <button 
              ...
              className="bg-[#144064] hover:bg-[#0f324f] text-white px-3.5 py-2 md:px-6 md:py-3 rounded-xl font-bold text-xs md:text-sm shadow-md transition-all flex flex-col items-center justify-center cursor-pointer leading-tight"
            >
              <span>ALG</span>
              <span>Wiki</span>
            </button>
            ...
            >
              ...
              <div className="text-[#144064] font-bold text-sm hidden md:block">
            ...
            <button 
              ...
              className="flex items-center space-x-1 bg-[#144064] hover:bg-[#0f324f] text-white p-2.5 md:px-6 md:py-3.5 rounded-full font-bold text-xs md:text-sm shadow-md transition-all cursor-pointer"
            >
