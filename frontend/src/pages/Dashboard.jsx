    ...
    <div className="flex flex-col md:flex-row min-h-screen bg-[#f4f7fc]">
      ...
      <aside className="hidden md:flex w-80 bg-white border-r border-gray-100 py-6 px-0 flex-col justify-between shrink-0 shadow-sm overflow-hidden">
        <div className="space-y-12">
          ...
          <nav className="space-y-4 px-3">
            <button 
              ...
              className="w-full py-4 px-6 rounded-full bg-[#3c7e8a] hover:bg-[#0f324f] text-white font-bold text-left transition-all text-sm flex items-center space-x-3 shadow-md cursor-pointer"
            >
            ...
            <button 
              ...
              className="w-full py-4 px-6 rounded-full bg-[#e3effd] hover:bg-[#d0e5fb] text-[#3c7e8a] font-bold text-left transition-all text-sm flex items-center space-x-3 cursor-pointer"
            >
        ...
        <div className="px-3">
          <button 
            onClick={() => navigate(-1)}
            className="w-12 h-12 rounded-2xl bg-[#3c7e8a] hover:bg-[#0f324f] text-white flex items-center justify-center shadow-md transition-all cursor-pointer"
          >
      ...
      <main className="flex-1 flex flex-col w-full">
        ...
        <header className="h-20 px-4 md:px-10 flex items-center justify-between border-b md:border-none border-gray-100 bg-white md:bg-transparent">
          ...
          <div className="flex items-center space-x-3">
            <button 
              ...
              className="md:hidden p-2.5 rounded-xl bg-[#e3effd] text-[#3c7e8a] cursor-pointer"
            >
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <button 
              ...
              className="bg-[#3c7e8a] hover:bg-[#0f324f] text-white px-3.5 py-2 md:px-6 md:py-3 rounded-xl font-bold text-xs md:text-sm shadow-md transition-all flex flex-col items-center justify-center cursor-pointer leading-tight"
            >
              <span>ALG</span>
              <span>Wiki</span>
            </button>
            ...
            >
              <div className="w-8 h-8 md:w-10 md:h-10 rounded-full bg-[#3c7e8a] flex items-center justify-center text-white shrink-0">
              ...
              <div className="text-[#3c7e8a] font-bold text-sm hidden md:block">
            ...
            <button 
              ...
              className="flex items-center space-x-1 bg-[#3c7e8a] hover:bg-[#0f324f] text-white p-2.5 md:px-6 md:py-3.5 rounded-full font-bold text-xs md:text-sm shadow-md transition-all cursor-pointer"
            >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-b border-gray-100 p-4 space-y-3 shadow-md">
            <button onClick={() => { navigate('/Assessment'); setIsMobileMenuOpen(false); }} className="w-full py-3 px-4 rounded-xl bg-[#3c7e8a] text-white font-bold text-sm text-left">
               Bắt đầu khảo sát mới
            </button>
            <button onClick={() => { navigate('/feedback'); setIsMobileMenuOpen(false); }} className="w-full py-3 px-4 rounded-xl bg-[#e3effd] text-[#3c7e8a] font-bold text-sm text-left">
               Đánh giá của người dùng
            </button>
            <button onClick={() => { navigate('/history'); setIsMobileMenuOpen(false); }} className="w-full py-3 px-4 rounded-xl bg-[#e3effd] text-[#3c7e8a] font-bold text-sm text-left">
        ...
        <section className="px-4 md:px-10 py-6 max-w-5xl space-y-8">
          ...
          <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
              <div className="w-16 h-16 rounded-2xl bg-[#e3effd] flex items-center justify-center text-[#3c7e8a] shrink-0 overflow-hidden p-3">
            ...
            <button 
              onClick={() => navigate('/Assessment')} 
              className="w-full md:w-auto bg-[#3c7e8a] hover:bg-[#0f324f] text-white font-bold py-3.5 px-8 rounded-full shadow-md text-sm transition-all shrink-0 cursor-pointer flex items-center justify-center space-x-2"
            >
