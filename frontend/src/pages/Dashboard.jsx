        ...
        <div className="space-y-12">
          ...
          <nav className="space-y-4 px-3">
            ...
            <button 
              ...
              className="w-full py-4 px-6 rounded-full bg-[#e3fdf3] hover:bg-[#d0e5fb] text-[#326871] font-bold text-left transition-all text-sm flex items-center space-x-3 cursor-pointer"
            >
      ...
      <main className="flex-1 flex flex-col w-full">
        ...
        <header className="h-20 px-4 md:px-10 flex items-center justify-between border-b md:border-none border-gray-100 bg-white md:bg-transparent">
          ...
          <div className="flex items-center space-x-3">
            <button 
              ...
              className="md:hidden p-2.5 rounded-xl bg-[#e3fdf3] text-[#326871] cursor-pointer"
            >
          ...
          <div className="flex items-center space-x-2 md:space-x-4">
            ...
            <div 
              ...
              className="flex items-center bg-[#e3fdf3] rounded-full p-2 md:px-5 md:py-2.5 md:space-x-3 cursor-pointer hover:bg-[#d0e5fb] transition-all shadow-sm"
            >
        ...
        {isMobileMenuOpen && (
          <div className="md:hidden bg-white border-b border-gray-100 p-4 space-y-3 shadow-md">
            ...
            <button onClick={() => { navigate('/feedback'); setIsMobileMenuOpen(false); }} className="w-full py-3 px-4 rounded-xl bg-[#e3fdf3] text-[#326871] font-bold text-sm text-left">
               Đánh giá của người dùng
            </button>
            <button onClick={() => { navigate('/history'); setIsMobileMenuOpen(false); }} className="w-full py-3 px-4 rounded-xl bg-[#e3fdf3] text-[#326871] font-bold text-sm text-left">
        ...
        <section className="px-4 md:px-10 py-6 max-w-5xl space-y-8">
          ...
          <div className="bg-white rounded-[2rem] p-6 md:p-8 shadow-sm border border-gray-100 flex flex-col md:flex-row items-center justify-between gap-6 text-center md:text-left">
            <div className="flex flex-col md:flex-row items-center space-y-4 md:space-y-0 md:space-x-6">
              <div className="w-16 h-16 rounded-2xl bg-[#e3fdf3] flex items-center justify-center text-[#326871] shrink-0 overflow-hidden p-3">
