...
// Import logo và brand text giống trang Dashboard
...
export default function Feedback() {
  ...
  return (
    <div className="flex min-h-screen bg-[#f4f7fc]">
      ...
      {/* 1. SIDEBAR BÊN TRÁI: Đồng bộ chính xác với Dashboard */}
      <aside className="w-80 bg-white border-r border-gray-100 py-6 px-0 flex flex-col justify-between shrink-0 shadow-sm overflow-hidden">
        <div className="space-y-12">
          ...
          <nav className="space-y-4 px-3">
            ...
            >
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2.5} stroke="currentColor" className="w-5 h-5 shrink-0 opacity-80">
        ...
        <header className="h-28 px-10 flex items-center justify-end space-x-4">
          ...
          >
            ...
            <div className="text-[#144064] font-bold text-sm">
              ...
              <div className="text-xs font-semibold opacity-80">user : {userObj.username || userObj.name || '...'}</div>
            </div>
          </div>
          ...
          <button 
            ...
            className="flex items-center space-x-2 bg-rose-50 hover:bg-rose-100 text-rose-600 border border-rose-200 px-6 py-3.5 rounded-full font-bold text-sm shadow-xs transition-all cursor-pointer"
          >
            <span>Đăng xuất</span>
        ...
        <section className="px-10 py-6 max-w-5xl space-y-8">
          <div>
            ...
            <p className="text-gray-500 font-medium mt-1 text-sm">
              Xem các nhận xét và phản hồi từ cộng đồng Aellergis.
            </p>
          </div>
