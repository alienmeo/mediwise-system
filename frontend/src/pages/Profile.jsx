    ...
    <div className="flex min-h-screen bg-[#f8fafc]">
      ...
      <aside className="w-80 bg-white border-r border-gray-100 p-6 flex flex-col shrink-0">
        <div className="space-y-10">
          ...
          {/* Brand Logo Header - Vị trí và kích thước đồng bộ tuyệt đối với Dashboard */}
          <div className="flex items-center justify-start cursor-pointer w-full overflow-hidden -ml-4 pl-3" onClick={() => navigate('/dashboard')}>
            <img src={logoImg} alt="Mediwise Logo" className="h-16 w-auto object-contain shrink-0" />
            <img src={brandTextImg} alt="Mediwise" className="h-12 w-auto object-contain max-w-[210px] shrink-0 -ml-3.5" />
          </div>
